...
df_ipca['IPCA acumulado'] = (1 + df_ipca['IPCA']/100)
df_ipca['IPCA acumulado'] = df_ipca['IPCA acumulado'].cumprod()
#MAGIA NEGRA PRA AJEITAR OS MESES 10 QUE TAO ESCRITOS COMO 01
df_ipca.to_csv('alface\\ipca_acumulado.csv')
print(df_ipca)